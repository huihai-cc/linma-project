...
var QC_I18N = {
  'zh-CN': {
    ...
    compareReset: '🗑️ 重新选择',
    compareBasicGroup: '基本对比：',
    compareExtraGroup: '附加对比：',
    compareCellContentOpt: '单元格内容',
    compareBgColorOpt: '🎨 背景颜色',
    compareFontColorOpt: '🔤 字体颜色',
    compareNumFmtOpt: '🔢 数字格式／单位',
    compareFormulaOpt: '🔢 公式',
    compareTextboxOpt: '📝 文本框',
    compareSheetStructureAuto: 'Sheet构成：自动检查',
    compareSheetStructureDiff: 'Sheet构成异常',
    compareSheetOnlyAMissing: '新表中未找到',
    compareSheetOnlyBAdded: '新表新增',
    compareUnsupportedFast: '高速模式不可用',
    compareUnsupportedZip: 'ZIP模式不可用',
  ...
  'ja-JP': {
    ...
    compareReset: '🗑️ 再選択',
    compareBasicGroup: '基本比較：',
    compareExtraGroup: '追加比較：',
    compareCellContentOpt: 'セル内容',
    compareBgColorOpt: '🎨 背景色',
    compareFontColorOpt: '🔤 文字色',
    compareNumFmtOpt: '🔢 数値書式／単位',
    compareFormulaOpt: '🔢 数式',
    compareTextboxOpt: '📝 テキストボックス',
    compareSheetStructureAuto: 'Sheet構成：自動チェック',
    compareSheetStructureDiff: 'Sheet構成差異',
    compareSheetOnlyAMissing: '新しい表に見つかりません',
    compareSheetOnlyBAdded: '新しい表に追加',
    compareUnsupportedFast: '高速モードでは利用できません',
    compareUnsupportedZip: 'ZIPモードでは利用できません',
